...
import { getData as getProfiles, getLoading as getProfilesLoading } from 'decentrastates-dapps/dist/modules/profile/selectors'
import { LOAD_PROFILE_REQUEST } from 'decentrastates-dapps/dist/modules/profile/actions'
