...
import { getData, getTransactions, getLoading } from 'decentrastates-dapps/dist/modules/authorization/selectors'
import {
  grantTokenRequest,
  GRANT_TOKEN_REQUEST,
  revokeTokenRequest,
...
import { areEqual } from 'decentrastates-dapps/dist/modules/authorization/utils'
